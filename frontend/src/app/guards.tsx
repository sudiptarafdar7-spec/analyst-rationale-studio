    ...
    return (
      <div className="grid h-full place-items-center p-8">
        <div className="card max-w-md p-8 text-center">
          ...
          <h2 className="mt-4 text-lg font-semibold">Permission required</h2>
          <p className="mt-1 text-sm text-slate-500">
            You don’t have access to this area. Contact your administrator if you believe this is an error.
          </p>
        </div>
      </div>
    );
